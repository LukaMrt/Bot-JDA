...
public class JDAServerMessageReactionRemovedEvent implements ServerMessageReactionRemovedEvent {

    private final GuildMessageReactionRemoveEvent event;

    public JDAServerMessageReactionRemovedEvent(GuildMessageReactionRemoveEvent event) {
        this.event = event;
    }
